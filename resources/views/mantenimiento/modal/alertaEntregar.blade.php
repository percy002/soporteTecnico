<form method="">
    ...
    <div class="mb-3 col-4">
        ...
        <input id="persona" name="persona" type="text" class="form-control" value="{{$trabajadores->name}}" tabindex="4" readonly>
    </div>
    <div class="mb-3 col-4">
        <label for="" class="form-label">DNI de la persona</label>
        <input id="DNI" name="DNI" type="text" class="form-control" value="{{$trabajadores->DNI}}" tabindex="5" readonly>
    </div>
    <div class="mb-3 col-4">
    ...
    <button type="button" class="btn btn-primary" tabindex="7" data-dismiss="modal">Guardar</button>
</form>